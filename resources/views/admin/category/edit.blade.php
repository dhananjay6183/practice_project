...
<div class="container">
    <div class="d-flex">
        <form action="{{ route('admin.category.update', ['id' => $category->id]) }}" method="POST" class="row g-3 bg-white m-5 p-5" id="categoryForm">
            @csrf
            <div class="col-md-6 mb-5">
                <label for="Category" class="form-label">Category</label>
                <input type="text" class="form-control" name="category" value="{{ $category->category }}" id="category_id" autocomplete="off">
            ...
            <div class="col-md-6 mb-5">
                ...
                <div class="d-flex">
                    <div class="radio-btns">
                        ...
                        <input type="radio" class="form-control btns-control" name="priority_id" value="high" id="high" {{ $category->priority == 1 ? 'checked' : '' }}>
                    </div>
                    <div class="radio-btns">
                        <label for="" class="text-capitalize">medium:</label>
                        <input type="radio" class="form-control btns-control" name="priority_id" value="medium" id="medium" {{ $category->priority == 1 ? 'checked' : '' }}>
                    </div>
                    <div class="radio-btns">
                        <label for="" class="text-capitalize">low:</label>
                        <input type="radio" class="form-control btns-control" name="priority_id" value="low" id="low" {{ $category->priority == 1 ? 'checked' : '' }}>
                    </div>
            ...
            <div class="col-md-6 mb-5">
                ...
                <textarea name="description" id="description" cols="40" rows="3" autocomplete="off">{{ $category->description }}</textarea>
            ...
            <div class="col-md-6 mb-5">
                ...
                <input type="text" class="form-control" name="date" value="{{ $category->date }}" id="datepicker" autocomplete="off">
                @if ($errors->has('date'))
