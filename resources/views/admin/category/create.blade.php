...
<div class="container">
    <div class="d-flex">
        <form action="{{ route('admin.category.store') }}" method="POST" class="row g-3 bg-white m-5 p-5" id="categoryForm">
            @csrf
            <div class="col-md-6 mb-5">
                <label for="Category" class="form-label">Category</label>
                <input type="text" class="form-control" name="category" id="category_id" autocomplete="off">
